/**
 * Created by zhanglongyu on 2017/3/23.
 * 使用方法：1、引入js和css
 *          2、<input type="text" id="demo" readonly=""  placeholder="请选择日期"  />
 *          3，var calendar = new LCalendar();
                 calendar.init({
                        'trigger': '#demo',//标签id
                        'type': 'date',//date 调出日期选择 datetime 调出日期时间选择 time 调出时间选择 ym 调出年月选择
                        'minDate':'1900-1-1',//最小日期 注意：该值会覆盖标签内定义的日期范围
                        'maxDate':'2133-3-18'//最大日期 注意：该值会覆盖标签内定义的日期范围
                    });
 */
